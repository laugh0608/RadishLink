...
- [`SW-EXP-003` mls-rs 0.56.0 实施与 Phase A 精确授权包](testing/sw-g2-mls-rs-phase-a-authorization.md)：A0/A1 已分别形成 clean revision，单元 C 已构建并复核固定审计工具 bundle `PASS`；单元 D 与候选运行未授权。
