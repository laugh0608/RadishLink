...
- [`SW-EXP-003` `debug_tree 0.4.0` R1d-U-P 上游澄清设计](testing/sw-g2-mls-rs-debug-tree-upstream-clarification-plan.md)：冻结唯一公开 Issue 的固定对象、精确全文、新 evidence 要求、回复接受标准与转 R1d-V 条件；尚未联网或发送。
