...
- [`SW-EXP-004` OpenMLS 0.9.0 实施骨架与 Phase A 精确授权包](testing/sw-g2-openmls-0.9-phase-a-authorization.md)：精确方案已接受，实施单元 A 已完成；L3 执行单元 B 未授权，且须先关闭 45 分钟与 5 GiB 运行上限控制差距。
