...
- [`SW-EXP-004` OpenMLS 0.9.0 实施骨架与 Phase A 精确授权包](testing/sw-g2-openmls-0.9-phase-a-authorization.md)：精确方案已接受，实施单元 A 与运行控制单元 A2 已完成本地实现、离线验证并形成 clean revision；L3 执行单元 B 未授权。
