...
- [`SW-EXP-003` mls-rs 0.56.0 许可证/NOTICE 补证与非实现者复核包](testing/sw-g2-mls-rs-license-notice-review.md)：R0 已离线固定 11 个随包证据不足 package、3 个上游仓库、6 个不可变 commit、受限联网来源、证据合同和独立复核清单；R1 helper/checker 已离线形成并验证，R1 联网、R2 与 Phase B 未授权。
