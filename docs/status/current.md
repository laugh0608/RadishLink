...
- [`mls-rs 0.56.0` 静态门禁](../testing/sw-g2-mls-rs-spike-authorization.md)与[OpenMLS 0.9.0 静态门禁](../testing/sw-g2-openmls-0.9-spike-authorization.md)均已接受。两者均未生成 RadishLink lockfile、未审计、未构建、未运行，也不得继承 OpenMLS 0.8.1 的授权或结论；
...
1. 形成[`OpenMLS 0.9.0` 静态门禁](../testing/sw-g2-openmls-0.9-spike-authorization.md)对应的“实施骨架 + Phase A”精确授权清单；在用户另行确认 L3 命令、副作用、时长和清理前，不新增文件、不联网、不下载、不生成 lockfile、不构建或运行；
